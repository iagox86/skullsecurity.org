...
date: '2008-08-29T13:45:34-05:00'
author: Andrew
layout: revision
guid: 'http://www.skullsecurity.org/blog/?p=13'
permalink: '/?p=13'
---
...
This returned all eight names owned by the box, including the computer's name ('TEST1'), the workgroup ('WORKGROUP'), the logged-in user ('RON'), and the special name whose meaning I don't understand yet ('\\x01\\x02\_\_MSBROWSER\_\_\\x02\\x01'). Additionally, it returned additional data. It's mostly 00s, but note the first 6 bytes -- Windows puts the box's MAC address there, while Samba leaves it blank.
