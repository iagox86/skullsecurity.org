...
date: '2008-11-12T12:07:33-05:00'
author: 'Ron Bowes'
layout: revision
guid: 'http://www.skullsecurity.org/blog/?p=115'
permalink: '/?p=115'
---
...
A SMB Relay attack is a type of man-in-the-middle attack where the attacker asks the victim to authenticate to a machine controlled by the attacker, then connects to the target, which the victim has access to. The attacker forwards the challenge from the server to the client, and the client answers based on that challenge, giving the attacker access. Here are the players:
