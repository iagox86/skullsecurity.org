...
date: '2008-09-02T14:50:44-05:00'
author: 'Ron Bowes'
layout: revision
guid: 'http://www.skullsecurity.org/blog/?p=50'
permalink: '/?p=50'
---
...
- 0 -- Clients use LM and NTLM. Servers accept LM, NTLM, and NTLMv2.
- 1 -- Clients use LM and NTLM, and NTLMv2 session security. Servers accept LM, NTLM, and NTLMv2.
- 2 -- Clients use NTLM, and NTLMv2 session security. Servers accept LM, NTLM, and NTLMv2.
- 3 -- Clients use NTLMv2, and NTLMv2 session security. Servers accept LM, NTLM, and NTLMv2.
- 4 -- Clients use NTLMv2, and NTLMv2 session security. Servers refuse LM, but accept NTLM and NTLMv2.
- 5 -- Clients use NTLMv2, and NTLMv2 session security. Servers refuse LM and NTLM, but accept NTLMv2.

Note that I haven't talked about session security at all. I might do that next.
