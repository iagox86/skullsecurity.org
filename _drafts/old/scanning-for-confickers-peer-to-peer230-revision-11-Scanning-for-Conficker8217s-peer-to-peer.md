...
date: '2009-04-21T13:42:38-05:00'
author: 'Ron Bowes'
layout: revision
guid: 'http://www.skullsecurity.org/blog/?p=241'
permalink: '/?p=241'
---
...
```
nmap -sP --script p2p-conficker -p445 --script-args=checkconficker=1 <target>
```
...
```
nmap -sP --script p2p-conficker,smb-os-discovery,smb-check-vulns -p445 --script-args=checkconficker=1,safe=1 -T4 <host>
```
