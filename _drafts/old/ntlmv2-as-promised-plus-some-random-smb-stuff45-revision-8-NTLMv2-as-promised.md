...
date: '2008-09-02T14:55:28-05:00'
author: 'Ron Bowes'
layout: revision
guid: 'http://www.skullsecurity.org/blog/?p=53'
permalink: '/?p=53'
---
...
- 0 -- **Client**: LM/NTLM. Servers accept LM, NTLM, and NTLMv2.
- 1 -- **Client**: LM/NTLM, NTLMv2 session security. **Server**: accept LM, NTLM, and NTLMv2.
- 2 -- **Client**: NTLM, NTLMv2 session security. **Server**: accept LM, NTLM, and NTLMv2.
- 3 -- **Client**: NTLMv2, NTLMv2 session security. **Server**: accept LM, NTLM, and NTLMv2.
- 4 -- **Client**: NTLMv2, NTLMv2 session security. **Server**: refuse LM, but accept NTLM and NTLMv2.
- 5 -- **Client**: NTLMv2, NTLMv2 session security. **Server**: refuse LM and NTLM, but accept NTLMv2.
