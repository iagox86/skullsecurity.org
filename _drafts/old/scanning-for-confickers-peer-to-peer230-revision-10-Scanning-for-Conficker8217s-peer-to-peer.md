...
date: '2009-04-20T10:46:26-05:00'
author: 'Ron Bowes'
layout: revision
guid: 'http://www.skullsecurity.org/blog/?p=240'
permalink: '/?p=240'
---
...
```
nmap -sP --script p2p-conficker,smb-os-discovery -p445 --script-args=checkconficker=1 <host>
```
