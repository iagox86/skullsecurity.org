...
date: '2010-03-08T14:22:50-05:00'
author: 'Ron Bowes'
layout: revision
guid: 'http://www.skullsecurity.org/blog/?p=570'
permalink: '/?p=570'
---
...
**UPDATE**: Looks like [Metasploit has a payload](http://www.metasploit.com/redmine/projects/framework/repository/revisions/8749/entry/modules/exploits/windows/backdoor/energizer_duo_payload.rb) to take advantage of this vulnerability. Sweet! Find the hosts with Nmap, exploit with Metasploit. Win!