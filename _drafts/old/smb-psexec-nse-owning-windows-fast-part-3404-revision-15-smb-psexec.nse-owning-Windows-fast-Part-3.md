...
date: '2010-01-19T15:22:52-05:00'
author: 'Ron Bowes'
layout: revision
guid: 'http://www.skullsecurity.org/blog/?p=421'
permalink: '/?p=421'
---
...
|     Reply from 10.0.0.138: bytes=32 time
<p>Notice how the ip got totally whacked. The outputted ip address, while consistent across multiple iterations, is completely wrong. tracert has the same problem. </p>
...
mod.noblank          = true
table.insert(modules, mod)
<p>This one is easy -- dump the arp cache of the host using the "arp -a" command. No special options are required. </p>
...
mod.noblank          = true
table.insert(modules, mod)
<p>Dump the routing table using netstat -nr. This command has to be run in a separate command session (that's why we have cmd.exe /c "netsat -nr"). It also requires the PATH variable to contain the 'windows' and 'system32' folders -- I don't know why that is. </p>
<p>Output:</p>
|     IPv4 Route Table
|     ===========================================================================
|     Interface List
