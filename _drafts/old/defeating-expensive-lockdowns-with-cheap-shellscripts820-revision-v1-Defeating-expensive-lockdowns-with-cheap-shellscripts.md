...
Another option would be to write a patch for [procps](http://procps.sourceforge.net/) that implements a bruteforce listing, but that was beyond what I really wanted to do.
