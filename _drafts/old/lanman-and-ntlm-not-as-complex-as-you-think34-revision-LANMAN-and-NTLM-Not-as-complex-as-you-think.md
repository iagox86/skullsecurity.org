...
date: '2008-08-31T20:36:16-05:00'
author: 'Ron Bowes'
layout: revision
guid: 'http://www.skullsecurity.org/blog/?p=35'
permalink: '/?p=35'
---

As I'm sure you've noticed with my first two posts, my NetBIOS/SMB project is taking up most of my time. I hit a bump this weekend, and almost got to the point where the only valid answer was throwing things, but luckily I made it over. However, I did make a new enemy: signed data types! The devil's datatype.

But sour grapes aside, I just finished implementing the two older (and most common by far) authentication mechanisms: LANMAN and NTLM. I'm also planning on implementing NTLMv2 in the near future, so stay tuned for that.

In the past, I've always feared LANMAN and NTLM, thinking that there was something inherently complex and tricky about them. However, once I got around to implementing them, I realized: they're dead simple! Nothing to it! They're so simple, in fact, that they're the perfect topic for a blog post.
