...
date: '2009-05-19T18:31:41-05:00'
author: 'Ron Bowes'
layout: revision
guid: 'http://www.skullsecurity.org/blog/?p=272'
permalink: '/?p=272'
---
...
At a high level, all you need to do is [Update Nmap from SVN](http://nmap.org/book/install.html#inst-svn) and run it with --script=http-webdav-unicode-bypass
...
Then compile it:  
`cd nmap<br></br>./configure<br></br>make<br></br>sudo make install<br></br>`
...
Once you're done all that, you're good to go.

### How do I run it?

Running it is as simple as running Nmap itself. Here's the simplest case:  
`nmap --script=http-webdav-unicode-bypass <target>`

Every port running HTTP will likely be checked. For a bit of a quicker check, try this:  
`nmap -p80,--script=http-webdav-unicode-bypass <target>`
