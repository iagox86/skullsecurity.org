...
date: '2009-02-19T17:10:50-05:00'
author: 'Ron Bowes'
layout: revision
guid: 'http://www.skullsecurity.org/blog/?p=175'
permalink: '/?p=175'
---
...
Well, the biggest disadvantage I ran across is that instead of locking out a single account and quitting (which I do as a protection against locking everybody out), every account is locked out before I realize it. Let's see how to mitigate that in....
...
jim:iloveyou => fail (+ locked out)  
mary:iloveyou => fail (+ locked out)  
ron:qwerty => locked out  
(quit)

As you can see, before we were told about one account lockout, three accounts were locked out. Oops!

The way to mitigate this issue is by
