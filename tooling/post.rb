# Do the following:
#
# * Post a hidden comments thread on Mastodon
# * Fill in the header of the file with the date/permalink/comments id
...
STATUS = MAS_CLIENT.create_status(
  "THIS IS EXPERIMENTAL AND DOES NOT LINK TO ANYTHING REAL YET!!\n\n" +
